...
public class InfiniteForExample {
	...
	public static void main(String[] args) {
		...
		*/
		//다시 확인
		 System.out.println("루프 탈출"); //무한 반복 활용 예
		 String answer = "자동차";
		 Scanner scan = new Scanner(System.in);
		 
//		 for(;;) { System.out.print(">"); String attempt = scan.nextLine();
//		 if(answer.equals(attempt)) { // 문자열 비교는 "=="를 쓰지 않음 equals() 메서드 사용
