...
//		System.out.println(welcome[2]);
		...
		// 배열의 내용 출력(arrys.toString() 메서드를 사용)
		...
		//정수는 0, 실수는 0.0 boolean : false, 참조형 : null
		...
		// 얕은 복사(swallow copy)는 변수의 byeMessage2에 주소값을 대입
//		byeMessage = byeMessage2;
//		byeMessage2[1] = "sayonara bye bye";
//		System.out.println(Arrays.toString(byeMessage));
		...
		// dest : 붙혀넣기할 배열의 이름
		// destPos : 붙혀넣기를 시작할 위치를 결정
		// length : 복사를 몇개나 할것인지 결정
